package com.apurebase.kgraphql.specification.v2016.introspection
...
class DeprecationSpecificationTest {
    ...
    fun `queries may be documented`(){
        ...
        val response = schema.executeBlocking("{__schema{queryType{fields(includeDeprecated: true){name, deprecationReason, isDeprecated}}}}")
    ...
    fun `mutations may be documented`(){
        ...
        val response = schema.executeBlocking("{__schema{mutationType{fields(includeDeprecated: true){name, deprecationReason, isDeprecated}}}}")
    ...
    fun `kotlin field may be documented`(){
        ...
        val response = schema.executeBlocking("{__type(name: \"Sample\"){fields(includeDeprecated: true){isDeprecated, deprecationReason}}}")
    ...
    fun `extension field may be documented`(){
        ...
        val response = schema.executeBlocking("{__type(name: \"Sample\"){fields(includeDeprecated: true){name, description, isDeprecated, deprecationReason}}}")
    ...
    fun `enum value may be deprecated`(){
        ...
        val response = schema.executeBlocking("{__type(name: \"SampleEnum\"){enumValues(includeDeprecated: true){name, isDeprecated, deprecationReason}}}")
    ...
    fun `type may be documented`(){
        ...
        val response = schema.executeBlocking("query { __type(name: \"Documented\") {  name, kind, description } }")
