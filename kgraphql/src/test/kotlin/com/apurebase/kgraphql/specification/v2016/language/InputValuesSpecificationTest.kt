...
class InputValuesSpecificationTest {
    ...
    fun `Int input value`(){
        val input = 4356
        val response = schema.executeBlocking("{Int(value : $input)}")
    ...
    fun `Float input value`(){
        ...
        val response = schema.executeBlocking("{Float(value : $input)}")
    ...
    fun `Double input value`(){
        ...
        val input = 4356.34
        val response = schema.executeBlocking("{Double(value : $input)}")
    ...
    fun `String input value`(){
        ...
        val response = schema.executeBlocking("{String(value : \"$input\")}")
    ...
    fun `Boolean input value`(){
        val input = true
        val response = schema.executeBlocking("{Boolean(value : $input)}")
    ...
    fun `Invalid Boolean input value`(){
        invoking {
            schema.executeBlocking("{Boolean(value : null)}")
    ...
    fun `Null input value`(){
        val response = schema.executeBlocking("{Null(value : null)}")
        response.extractOrNull<String>("data/Null").shouldBeNull()
    }

    @Test
    @Specification("2.9.6 Enum Value")
    fun `Enum input value`(){
        val response = schema.executeBlocking("{Enum(value : ENUM1)}")
    ...
    fun `List input value`(){
        val response = schema.executeBlocking("{List(value : [23, 3, 23])}")
