...
class DocumentationSpecificationTest {
    ...
    fun `queries may be documented`(){
        ...
        val response = schema.executeBlocking("{__schema{queryType{fields{name, description}}}}")
    ...
    fun `mutations may be documented`(){
        ...
        val response = schema.executeBlocking("{__schema{mutationType{fields{name, description}}}}")
    ...
    fun `object type may be documented`(){
        ...
        val response = schema.executeBlocking("{__type(name: \"Sample\"){description}}")
    ...
    fun `kotlin field may be documented`(){
        ...
        val response = schema.executeBlocking("{__type(name: \"Sample\"){fields{description}}}")
    ...
    fun `extension field may be documented`(){
        ...
        val response = schema.executeBlocking("{__type(name: \"Sample\"){fields{name, description}}}")
    ...
    fun `enum value may be documented`(){
        ...
        val response = schema.executeBlocking("{__type(name: \"SampleEnum\"){enumValues{name, description}}}")
